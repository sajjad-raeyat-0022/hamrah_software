                ...
                <ul class="nav navbar-nav flex-row">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span class="hidden-xs">{{ $authUser->name == null ? $authUser->phone_number : $authUser->name  }}</span>
                        </a>
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <img src="@php
                                        ...
                                        @endphp" class="img-circle" alt="User_Image">
                                ...
                                <p>
                                    ...
                                    @endrole
                                    @role('master')
                                    <small>کاربر و مدرس دوره</small>
                                    @endrole
                                    @role('ta-master')
                                    <small> کاربر و کمک یار مدرس</small>
                                    @endrole
                                </p>
                            </li>
                            ...
                            <li class="user-footer text-center">
                                ...
                                <div class="pull-right">
                                    <a href="{{ route('user.users_profile.index') }}" class="btn btn-default btn-flat">پروفایل</a>
                                </div>
                                @endif
                                <div class="pull-left">
