                ...
                <div class="col-xl-12 col-md-12 mb-4 p-md-5 bg-white">
                    ...
                    <div class="box box-warning bg-light">
                        ...
                        <form action="{{ route('admin.categories.update', ['category' => $category->id]) }}" method="POST">
                            ...
                            <button class="btn btn-warning mt-4 mb-5 mx-3" type="submit">ویرایش</button>
                            <a href="{{ route('admin.categories.index') }}" class="btn btn-secondary mt-4 mr-3 mb-5">بازگشت</a>
                        </form>
                    </div>
                </div>
            </div>
