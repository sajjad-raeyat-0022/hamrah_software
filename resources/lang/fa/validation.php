...
return [
    ...
    */
    ...
    'attributes'           => [
        ...
        'category_id'              => 'انتخاب دسته بندی',
        'variation_values'              => 'ویژگی ها',
        'delivery_amount'              => 'هزینه ارسال',
        'attribute_ids.*'              => 'ویژگی ها',
        'attribute_values'              => 'ویژگی ها',
        'variation_values.*.price'              => 'قیمت ویژگی متغیر',
        'variation_values.*.quantity'              => 'تعداد ویژگی متغیر',
        'variation_values.*.sku'              => 'شناسه انبار ویژگی متغیر',
        'variation_values.*.sale_price'              => 'قیمت حراجی محصول',
        'image'              => 'عکس',
        'priority'              => 'اولویت',
        'type'              => 'نوع',
        'otp'              => 'کد تاییدیه',
        'login_token'              => 'توکن لاگین',
        'amount'              => 'مبلغ',
        'percentage'              => 'درصد',
        ...
        'q4.*'              => 'گزینه 4',
        'grade.*'              => 'نمره سوال',
        'true_answer.*'              => 'پاسخ صحیح سوال',
        'course_id'              => 'دوره',
        'randon_number'              => 'تعداد سوالات',
        'final_grade'              => 'نمره نهایی امتحان',
    ],
